...
# $args1 - file name
	...
	ansible-playbook ../$1.yml --vault-password-file ~/.vault_pass.txt >> ../$logs/ansible-pb-${1}.log
	echo "`date` completed: ansible-playbook ${1}.yml" >> ../$logs/ansible-pb-${1}.log
	...
	if [ `ls ../$logs/*.log | wc -l` -lt 2 ]
		...
		python get-aws-instance-details.py
